...
import TableFilterCourse from "@/components/Table/TableFilterCourse";
import TableFilterSearch from "@/components/Table/TableFilterSearch";
import TableFilterTerm from "@/components/Table/TableFilterTerm";
import TableFilterYear from "@/components/Table/TableFilterYear";
...
export default function ReviewList({ reviews, user }: Props) {
