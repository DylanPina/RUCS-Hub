...
import ChartRating from "@/components/Chart/ChartRating";
  ...
  return (
    <div className="flex flex-col w-full lg:w-1/2 space-y-3">
      ...
      <div className="w-full h-full">
        {ratingChart === "Rating" && (
          <ChartRating reviews={reviews} attribute="rating" />
        )}
        {ratingChart === "Difficulty" && (
          <ChartRating reviews={reviews} attribute="difficultyRating" />
        )}
      </div>
    </div>
  );
