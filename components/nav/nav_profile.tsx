            ...
            <TooltipTrigger className="focus:outline-none">
              <DropdownMenu>
                <DropdownMenuTrigger className="flex align-center outline-none">
                  ...
                  >
                    <Avatar className="w-8 h-8 outline outline-2 shadow-sm shadow-primary-white/20 outline-primary-white transition duration-150 ease-out hover:ease-in hover:outline-primary-red hover:shadow-primary-red">
                      <AvatarImage
